...
void sendMQTT() {
  ...
  Serial.println(msg);
  client.publish("student/CASA0014/plant/ucbqwdm/temperature", msg);

  Humidity = dht.readHumidity(); // Gets the values of the humidity
  snprintf (msg, 50, "%.0f", Humidity);
  Serial.print("Publish message for h: ");
  Serial.println(msg);
  client.publish("student/CASA0014/plant/ucbqwdm/humidity", msg);

  //Moisture = analogRead(soilPin);   // moisture read by readMoisture function
  snprintf (msg, 50, "%.0i", Moisture);
  Serial.print("Publish message for m: ");
  Serial.println(msg);
  client.publish("student/CASA0014/plant/ucbqwdm/moisture", msg);
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str(), mqttuser, mqttpass)) {
      ...
      // ... and resubscribe
      client.subscribe("student/CASA0014/plant/ucbqwdm/inTopic");
    } else {
